        ...
        <header className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-800/50 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
            <div className="flex flex-wrap items-center gap-2">
                <p className="text-sm/6 text-gray-100">
                    <strong className="font-semibold">Defend Democracy</strong>
                    <svg
                        viewBox="0 0 2 2"
                        aria-hidden="true"
                    ...
                    footer={
                        <>
                            <div className="flex flex-row justify-center space-x-7">
                                <SocialLinks
                                    classNames="h-6 w-6 fill-gray-500 transition duration-300 hover:scale-125 hover:fill-pink-700"
                                    location="landing"
                                />
                            </div>
