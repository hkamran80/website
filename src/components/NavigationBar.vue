        ...
        <div class="block sm:flex sm:justify-between sm:items-center mb-6 pt-3">
            ...
            <div class="flex justify-between items-center px-6 pt-2 sm:px-0">
                ...
                <div>
                    <router-link
                        to="/"
                        class="block text-left text-lg font-bold text-primary-dark dark:text-ternary-light hover:text-pink-800 dark:hover:text-pink-400 sm:mx-4 mb-2 sm:py-2"
                    >
                        H. Kamran
                    </router-link>
                </div>
            ...
            >
                <router-link to="/creations" class="link" aria-label="Projects">
                    Creations
                </router-link>
                <router-link to="/blog" class="link" aria-label="Blog">
                    Blog
                </router-link>
                <router-link to="/notes" class="link" aria-label="Notes">
                    Notes
                </router-link>
                <router-link to="/programs" class="link" aria-label="Programs">
                    Programs
                </router-link>
            </div>
            <!-- Header links end -->
...
nav .link {
    @apply block text-left text-lg font-medium text-primary-dark dark:text-ternary-light hover:text-pink-800 dark:hover:text-pink-400 sm:mx-4 mb-2 sm:py-2;
}
</style>
