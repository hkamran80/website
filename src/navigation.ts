...
export const sitemap: SitemapItem[] = [
    { href: "/bill-analysis", name: "Bill Analysis", description: "Analyses of legislative bills I have compiled" },
    { href: "/colophon", name: "Colophon", description: "How this site is made" },
    { href: "/defaults", name: "Defaults", description: "A list of apps I use" },
    { href: "/feeds", name: "Feeds", description: "My web feeds" },
    { href: "/", name: "Homepage", description: "Press start to begin" },
    { href: "/license", name: "License", description: "The license for this site" },
    { href: "/ai", name: "LLM Policy", description: "Policy on the use of large language models (LLMs)" },
