 ...
 * ```
 */ export const rkeyFromUrl = (url, strategy = "tidFromPath")=>rkeyFromPath(url.pathname, strategy);
export const rkeyFromPath = (path, strategy)=>strategy === "anyFromPath" ? anyFromPath(path) : tidFromPath(path);
export const anyFromPath = (path)=>{
